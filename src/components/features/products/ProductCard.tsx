...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm transition-all hover:shadow-md">
      <div className="aspect-[4/3] bg-white dark:bg-gray-800 sm:aspect-[4/3] sm:h-auto w-full overflow-hidden relative border-b border-gray-100 dark:border-gray-700">
        <Image
          src={product.image}
          alt={product.title}
          fill
